...
(function IIFE($, window, document) {
  ...
  var drawingObj = {
    ...
    drawSection: function drawSection(section, color, xCord, yCord, radius) {
      section.beginPath();
  ...
  var gameFunctions = {
    ...
    alertWin1: function alertWin1() {
      $("#score").text("WIN").css("color", "green");
    },
    alertWin2: function alertWin2() {
      $("#score").text("WIN").css("color", "white");
    },
    playCompMoves: function playCompMoves() {
    ...
    replayLastCompMoves: function replayLastCompMoves() {
      compPlay = setInterval(increaseIndex, 800);
    },
    updatePlayerMove: function updatePlayerMove(indexPlayed) {
      gameStats.playerMoves.push(indexPlayed);
      gameStats.playerIndex += 1;
    },
    checkPlayerMove: function checkPlayerMove() {
    ...
    strictModeCheckPlayerMove: function strictModeCheckPlayerMove() {
      if (gameStats.playerMoves[gameStats.playerIndex] != gameStats.compMoves[gameStats.playerIndex]) {
    ...
    generateCompMoves: function generateCompMoves() {
      for (var i = 0; i < 2; i++) {
  ...
  var eventTriggers = {
    ...
    $enablePressing: function $enablePressing() {
    ...
    $disablePressing: function $disablePressing() {
      $("#canvas1").off();
      $("#canvas2").off();
      $("#canvas3").off();
      $("#canvas4").off();
