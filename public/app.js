...
var $onOffSwitch = (0, _jquery2.default)('#myonoffswitch');
var $playBtn = (0, _jquery2.default)('.playBtn');
var $resetBtn = (0, _jquery2.default)('.resetBtn');
var $gamePieces = (0, _jquery2.default)('.gameContainer').children();
var $round = (0, _jquery2.default)('.round');
...
var playCompMoves = function playCompMoves(compMoves, gameRound) {
  var glowSpeed = 500;
  var moveSpeed = 600;
  var glowSpeedPct = 1 - gameRound / 100;
  var glowTime = glowSpeed * glowSpeedPct;
  var cpuMoves = compMoves.slice(0, gameRound);
  cpuMoves.forEach(function (el, index) {
    setTimeout(function () {
...
var playCompMovesReverse = function playCompMovesReverse(compMoves, gameRound) {
  var cpuMovesReverse = compMoves.slice(0, gameRound);
  cpuMovesReverse.forEach(function (el, index) {
    setTimeout(function () {
...
(0, _jquery2.default)('.gameContainer').on('click', 'div', function gameContainer(event) {
  if (!gameStats.compTurn) {
    event.stopPropagation();
    var colorIndex = (0, _jquery2.default)(this).data('colorindex');
